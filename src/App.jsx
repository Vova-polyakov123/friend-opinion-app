    ...
    return (
      ...
      <div style={styles.bg}>
        ...
        <div style={styles.card}>
          ...
          <p>
            Вы выбираете друга из списка
            и отвечаете на вопросы.
            Ответы приходят анонимно.
          </p>

          <p>
            Чтобы выбрать друга,
            нужно разрешить доступ к списку друзей.
          </p>
    ...
    return (
      ...
      <div style={styles.bg}>
        ...
        <div style={styles.card}>
          ...
          <p>
            Без доступа нельзя выбрать друга
            для опроса
          </p>
